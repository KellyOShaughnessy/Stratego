...
let computer_list =
  [({pce="Spy";id=1},(9,1));
  ({pce="Scout";id=1},(9,2));
  ({pce="Captain";id=1},(9,3));
  (({pce="Major";id=1}),(9,3));
  (({pce="Flag";id=1}),(9,5));
  (({pce="Sergeant";id=1}),(9,6));
  ({pce="Colonel";id=1},(9,7));
  (({pce="Miner";id=1}),(9,8));
  (({pce="General";id=1}),(9,9));
  (({pce="Captain";id=2}),(9,10));
  (({pce="Miner";id=2}),(10,1));
  (({pce="Marshal";id=1}),(10,2));
  (({pce="Lieutenant";id=1}),(10,3));
  (({pce="Bomb";id=1}),(10,4));
  (({pce="Bomb";id=2}),(10,5));
  (({pce="Bomb";id=3}),(10,6));
  ({pce="Scout";id=2},(10,7));
  (({pce="Lieutenant";id=2}),(10,8));
  (({pce="Sergeant";id=2}),(10,9));
  ({pce="Scout";id=3},(10,10))]
...
let game_board =
[
((10,1),Some ({pce="Miner";id=1}, computer));
((10,2),Some ({pce="Marshal";id=1}, computer));
((10,3),Some ({pce="Lieutenant";id=1}, computer));
((10,4),Some ({pce="Bomb";id=1}, computer));
((10,5),Some ({pce="Bomb";id=2}, computer));
((10,6),Some ({pce="Bomb";id=3}, computer));
((10,7),Some ({pce="Scout";id=1}, computer));
((10,8),Some ({pce="Lieutenant";id=2}, computer));
((10,9),Some ({pce="Sergeant";id=1}, computer));
((10,10),Some ({pce="Scout";id=2}, computer));

((9,1),Some ({pce="Spy";id=1},computer));
((9,2),Some ({pce="Scout";id=3},computer));
((9,3),Some ({pce="Captain";id=1},computer));
((9,4),Some ({pce="Major";id=1},computer));
((9,5),Some ({pce="Flag";id=1},computer));
((9,6),Some ({pce="Sergeant";id=2},computer));
((9,7),Some ({pce="Colonel";id=1},computer));
((9,8),Some ({pce="Miner";id=2},computer));
((9,9),Some ({pce="General";id=1},computer));
((9,10),Some ({pce="Captain";id=2},computer));
...
((2,1),Some ({pce="Miner";id=1}, hum));
((2,2),Some ({pce="Marshal";id=1}, hum));
((2,3),Some ({pce="Lieutenant";id=1}, hum));
((2,4),Some ({pce="Bomb";id=1}, hum));
((2,5),Some ({pce="Bomb";id=2}, hum));
((2,6),Some ({pce="Bomb";id=3}, hum));
((2,7),Some ({pce="Scout";id=1}, hum));
((2,8),Some ({pce="Lieutenant";id=2}, hum));
((2,9),Some ({pce="Sergeant";id=1}, hum));
((2,10),Some ({pce="Scout";id=2}, hum));

((1,1),Some ({pce="Spy";id=1},hum));
((1,2),Some ({pce="Scout";id=3},hum));
((1,3),Some ({pce="Captain";id=1},hum));
((1,4),Some ({pce="Major";id=1},hum));
((1,5),Some ({pce="Flag";id=1},hum));
((1,6),Some ({pce="Sergeant";id=2},hum));
((1,7),Some ({pce="Colonel";id=1},hum));
((1,8),Some ({pce="Miner";id=2},hum));
((1,9),Some ({pce="General";id=1},hum));
((1,10),Some ({pce="Captain";id=2},hum));
]
...
let miner1 = {pce="Miner";id=1}
let miner2 = {pce="Miner";id=2}
...
TEST = (List.assoc (2,2) new_gb3) = Some ({pce="Marshal";id=1}, hum3)
